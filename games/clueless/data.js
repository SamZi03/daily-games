// ============================================
// CLUELOCK — DATA FILE
// Add new words here. game.js handles all logic.
//
// WORDS: add new entries at the end of the array.
// SIMILARITY: add a matching key block (see format below).
// CLUES: add a matching key with 5 clues (vague → obvious).
//
// SIMILARITY compact format:
//   word: { close1:97, close2:95, ..., far1:10, far2:5 },
// Scores 5–99 (higher = closer). ~40-50 entries per word ideal.
// ============================================
...
const SIMILARITY = {
    ...
    jungle: {
        ...
        hot:55,humid:53,wet:51,rain:49,green:47,
        river:45,mud:43,swamp:41,bush:39,grass:37,
        explore:35,adventure:33,danger:31,hunt:29,survive:27,
        tribe:25,africa:23,brazil:21,dark:19,thick:17,
        deep:15,wildlife:13,nature:11,travel:8,remote:6,
        cold:4,city:5,road:6,dry:5,
    },
    gold: {
    ...
    vampire: {
        ...
        cold:13,silent:10,alone:7,lost:5,
    },
    treasure: {
